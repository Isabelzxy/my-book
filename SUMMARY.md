...
* [JAVA 并发编程](JAVA/threads.md)
    ...
    * [5.线程及状态](JAVA/threads.md#5线程及状态)
    * [5.线程池的工作原理以及几个重要参数的设置](JAVA/threads.md#5线程池的工作原理以及几个重要参数的设置)
    * [5.sleep 与 wait 区别](JAVA/threads.md#5sleep-与-wait-区别)
...
* [JVM](JAVA/jvm.md)
    ...
    * [2.分代、分区收集算法](JAVA/jvm.md#2分代、分区收集算法)
    ...
    * [10.简述CMS与G1区别](JAVA/jvm.md#10简述cms与g1区别)
    * [10.G1垃圾回收器 vs CMS 垃圾回收器](JAVA/jvm.md#10g1垃圾回收器-vs-cms-垃圾回收器)
    * [11.GC 调优的两大目标是啥](JAVA/jvm.md#11gc-调优的两大目标是啥)
    * [12.GC 如何调优](JAVA/jvm.md#12gc-如何调优)
    * [12.JVM调优参数](JAVA/jvm.md#12jvm调优参数)
...
* [架构设计](架构设计/arch.md)
    ...
    * [3.分布式唯一ID](架构设计/arch.md#3分布式唯一id)
    * [4.CAP](架构设计/arch.md#4cap)
