...
* [Kafka](Kafka/kafka.md)
    ...
    * [11.Kafka中的消息丢失、重复消费、乱序问题](Kafka/kafka.md#11kafka中的消息丢失、重复消费、乱序问题)
    * [12.ZooKeeper在Kafka中的作用是什么](Kafka/kafka.md#12zookeeper在kafka中的作用是什么)
    * [13.重要参数有哪些](Kafka/kafka.md#13重要参数有哪些)
    * [14.controller 的职责有哪些](Kafka/kafka.md#14controller-的职责有哪些)
    * [15.broker、leader、controller挂掉会怎样](Kafka/kafka.md#15broker、leader、controller挂掉会怎样)
    * [16.Page Cache 带来的好处](Kafka/kafka.md#16page-cache-带来的好处)
